document.addEventListener("DOMContentLoaded", function () {
  ...
  function populateItemList(itemId){
    itemList.innerHTML = "";
      defaultItems[itemId].forEach((item) => {
  ...
  addItemBtn.onclick = function () {
    ...
    console.log(currentManageSelect);
    console.log(currentManageSelect.id);
    if (
      newItemValue &&
      ...
      populateItemList(currentManageSelect.id);
