        ...
        .then(data => {
            ...
            submitButton.addEventListener('click', () => {
                ...
                data.quiz.forEach((question, qIndex) => {
                    ...
                    const questionElement = document.querySelectorAll('.question')[qIndex];

                    if (selectedOption) {
                        if (selectedOption.value === question.answer) {
                            score++;
                            questionElement.classList.add('correct');
                            questionElement.insertAdjacentHTML('beforeend', '<span class="icon icon-correct">&#10003;</span>');
                        } else {
                            questionElement.classList.add('incorrect');
                            questionElement.insertAdjacentHTML('beforeend', '<span class="icon icon-incorrect">&#10007;</span>');
                        }
                    } else {
                        questionElement.classList.add('incorrect');
                        questionElement.insertAdjacentHTML('beforeend', '<span class="icon icon-incorrect">&#10007;</span>');
                ...
                resultText.textContent = `${score} out of ${totalQuestions}`;
